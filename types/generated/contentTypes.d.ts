...
export interface ApiSchoolSchool extends Schema.SingleType {
  ...
  attributes: {
    schools: Attribute.Component<'timeline-content.school', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSectionSection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    continue: Attribute.Component<'other.continue-link'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWorkWork extends Schema.SingleType {
  ...
  attributes: {
    jobs: Attribute.Component<'timeline-content.job', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
